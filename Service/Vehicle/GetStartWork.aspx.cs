    ...
    public partial class GetStartWork : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数No,CodeCompany，RecognizeMethod不能为null！举例：http://218.92.115.55/M_ZJG_Dzqp/Service/Vehicle/GetStartWork.aspx?No=690000&CodeCompany=77&RecognizeMethod=CARD");
